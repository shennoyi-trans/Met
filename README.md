...
---
Mofu是一款桌宠软件，面向身处异地的同行者。 

双方的桌宠会一起出现在同一张桌面上，向对方展示自己目前的状态。（前台应用名、正在播放的音乐、键盘敲击强度等等，可以选择其中一个展示）

只需轻触鼠标，您便可以控制自己的桌宠与对方进行丰富的互动，或搬动环境中的小物件，在寂静的夜晚制造一点可爱的小动静。如果朋友送来了围巾，那一定是要降温了，注意添衣哦。 

您也可以通过桌宠的小小魔法，向对方共享您的屏幕，并在需要的时候邀请对方帮忙控制电脑。 另外，在待机状态下，两只宠物会在内置AI的驱动下自发地进行互动。即使不进行任何操作，也可以静静地观察它们亲昵，打闹，重归于好。 
...
一只简易的海鸥出现在屏幕左上角，进入待机状态，始终置顶。 待机状态下，海鸥可以按住左键拖动，支持多显示器。
