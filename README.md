...
- **动作触发** — 以特定方式按住左键拖动鼠标，召唤桌宠进行互动
- **丰富功能** — 可在召唤桌宠后进行天文奇观查询、生日提醒、缓存清理等
- **宠物派遣** — 把自己的桌宠送到好友桌面上，或把对方的桌宠带回来
- **待机模式** — 长时间不操作时，宠物会暗中观察，努力变得更聪明
- **双宠同屏** — 两只宠物同框时可进行丰富的互动，如格斗比赛等
- **定制桌宠** — 插件化宠物组件，后续可接入更多宠物和功能，支持自定义
